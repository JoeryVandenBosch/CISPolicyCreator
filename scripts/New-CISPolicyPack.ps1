...
$manifest=[ordered]@{
    ...
    build=[ordered]@{ toolVersion='0.2.0'; extractorVersion='0.3.0'; pdfParser='pypdf'; pdfParserVersion='6.15.0'; mappingCatalogId=$MappingCatalogId; mappingCatalogVersion=$MappingCatalogVersion; mappingCatalogSha256=$MappingCatalogSha256.ToLowerInvariant(); administratorDecisionsSha256=$null; settingsCatalogSnapshotSha256=$null }
