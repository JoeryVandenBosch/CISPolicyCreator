...
- Publish orchestrated packs with atomic same-parent moves and ownership-scoped cleanup so a raced output path created by another process is never overwritten or deleted.
